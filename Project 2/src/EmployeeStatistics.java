...
public class EmployeeStatistics {
	...
	public static void numberOfEmployees() {
		...
		System.out.println("The % of employees in Admin is: " + 100.00 * (double) percentageOfAdmin/(double) EmployeeMain.myEmployees.size() + "%");
		System.out.println("The % of employees in Development is: " + 100.00 * (double) percentageOfDevelopment/(double)EmployeeMain.myEmployees.size() + "%");
		System.out.println("The % of employees in Support is: " + 100.00 * (double)percentageOfSupport/(double)EmployeeMain.myEmployees.size() + "%");
	}
