...
public class Question2Lecture2 {

	public static void main(String[] args) {
		
		int dogs = 1; int cats = 2;
		if (dogs > 0 && cats == 0) { 
			if (dogs > 1) { 
			...
			{ if (dogs > cats) { System.out.println("I guess you like dogs more"); 
			} else if (dogs == cats) 
			{ System.out.println("I guess you like both equally"); 
			} else { 
				System.out.println("I guess you like cats more"); } 
			} else { System.out.println("What, don’t you like pets?"); }
