		...
		while(running) {
			...
			while (enemyHealth > 0) {
				...
				if (input.equals("1")) {
					...
					System.out.println("\t> You drink the health potion, healing yourself for " + healthPotionHeal
											+ "\n\t> You now have " + health + " HP."
											+ "\n\t> you have " + numHealthPotions + " health potions left.");
					
					}
					else {
						System.out.println("\t> You have no potions left! Defeat enemies for a chance of drop!");
					}
				}
			...
			if (health < 1) {
				System.out.println("You escape the dungeon, weak from battle.");
				break;
			}
			...
			if(input.equals("1")) {
				...
				System.out.println("You exit the dungeon! You win!");
				break;
			}
